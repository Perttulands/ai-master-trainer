    ...
    >
      <div className="space-y-6">
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex gap-3">
          ...
          <div>
            <h3 className="font-medium text-blue-900">LiteLLM API Key Required</h3>
            <p className="text-sm text-blue-700 mt-1">
              To use the advanced features of Training Camp, you need to provide your LiteLLM API key.
