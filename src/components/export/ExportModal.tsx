...
import { Check, Copy, Download, FileJson, FileCode, FileType } from 'lucide-react';
...
export function ExportModal({ isOpen, onClose, agents }: ExportModalProps) {
  ...
  }, [exportedContent, agents, selectedAgents, format]);

  const allSelected = selectedAgents.size === agents.length;
  const noneSelected = selectedAgents.size === 0;

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Export Agents" size="xl">
      <div className="flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            >
              {noneSelected ? (
                <span className="text-gray-500">Select at least one agent to preview export</span>
              ) : (
